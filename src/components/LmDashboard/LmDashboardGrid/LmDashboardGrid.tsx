...
import style from './LmDashboardGrid.module.scss'
...
const LmDashboardGrid: React.FC<{
  page: number,
  rowsPerPage: number,
    ...
    <section className={style.gridContainer}>
      <div className={style.gridHeader}>
        ...
        <div className='layout-row'>
          <CustomButton text='Pending Request' border='1px solid #6e6e6e' bgColor='#282828' onClick={() => { navigate(APP_ROUTES.ADD_REQUEST_CREATION) }} />
        </div>
      </div>
...
export default LmDashboardGrid
